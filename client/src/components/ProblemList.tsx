      ...
      {!loading
        ? problems.map((item, index) => (
            ...
            >
              ...
              <button className={`p-2 px-4 outline-none rounded shadow text-white ${isItSolved(item.whoSolved) ? "bg-green-600 font-semibold" : "bg-black hover:bg-white hover:text-black hover:border"}`}>
