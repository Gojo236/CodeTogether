    ...
    <div className="relative">
      {!loading ? (
        <>
          ...
          <MDEditor.Markdown source={problem?.statement} style = {{color:"#171715", backgroundColor:"white"}} />
          {problem?.input && (
            <div className="my-6">
              <h2 className="text-lg mb-2">Input Format</h2>
              <MDEditor.Markdown source={problem?.input} style = {{color:"#171715", backgroundColor:"white"}}/>
            </div>
          )}
          {problem?.output && (
            <div className="my-6">
              <h2 className="text-lg mb-2">Output Format</h2>
              <MDEditor.Markdown source={problem?.output} style = {{color:"#171715", backgroundColor:"white"}}/>
            </div>
          )}
          {problem?.constraints && (
            <div className="my-6">
              <h2 className="text-lg mb-2">Constraints</h2>
              <MDEditor.Markdown source={problem?.constraints} style = {{color:"#171715", backgroundColor:"white"}}/>
            </div>
          )}
          {sampleTestcase &&
